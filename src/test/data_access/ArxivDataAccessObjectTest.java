...
//    Author Changyu = AF.createWithoutAffiliation("Changyu Dong");
    ...
    ResearchPaper paper = new ResearchPaper("2311.16844", "A Direct Lazy Sampling Proof Technique in Probabilistic Relational Hoare Logic", categories, authors, LocalDate.parse("2023-11-28"), summary, "https://arxiv.org/abs/2311.16844", 0, 0);
    ArxivDataAccessObject arxdao = new ArxivDataAccessObject(categories, authors);
    @org.junit.Test
    public void testGetPaperById(){
        assert(arePapersSame(paper, arxdao.getPaperById("2311.16844")));
    }
